...
public interface DataFormDtoMapper {
    ...
    @Select(" select gbdaccage as code_client, gbdacnomb as names, gbdacape1 as last_name, " +
            ...
            " '' as activity1, '' as activity2, cacondesc as reason_opening_account, gbdaccony as code_spouse," +
            " camcafapt as opening_date, gbciuciud as city " +
            " from gbdac " +
            ...
            " inner join gbdir on gbdircage = gbagecage and gbdirtdir = 1  " +
    ...
    @Select(" select gbdaccage as code_client, gbdacnomb as names, gbdacape1 as last_name, " +
            ...
            " gbprvdesc as province, gbdptdesc as departament, gbpaidesc as country, gbzondesc as zone, " +
            " gbdaccelu as cellphone, gbagetlfd as home_phone, " +
            " '' as activity1, '' as activity2, '' as reason_opening_account, gbdaccony as code_spouse," +
            " pfmdpfreg as opening_date, gbciuciud as city " +
            " from gbdac " +
            " inner join gbage on gbagecage = gbdaccage " +
